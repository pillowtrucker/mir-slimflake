...
, pkg-config, python3, boost, egl-wayland, freetype, glib, glm, glog, libdrm
, libepoxy, libevdev, libglvnd, libinput, libuuid, libxcb, libxkbcommon
, libxmlxx, yaml-cpp, lttng-ust, mesa, nettle, udev, wayland, xorg, xwayland
, gobject-introspection, wayland-scanner, dbus, gtest, umockdev, wlcs
, validatePkgConfig }:
...
stdenv.mkDerivation (finalAttrs: rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "mir";
    rev = version;
    hash = "sha256-MsdEIjlv/RJnvGo1H1e9/Fcn/gbVrh1M78OZWRWqHh8=";
  };
  ...
  #      url =
  #        "https://github.com/MirServer/mir/commit/98250e9c32c5b9b940da2fb0a32d8139bbc68157.patch";
  ...
  nativeBuildInputs = [
    ...
    (python3.withPackages (ps:
      with ps;
      [ pillow ] ++ lib.optionals finalAttrs.finalPackage.doCheck [
        pygobject3
        python-dbusmock
      ]))
    validatePkgConfig
